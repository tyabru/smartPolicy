...
<script>
import MapComponent from "@/views/components/wvp/common/MapComponent.vue";
import DeviceService from "@/utils/service/DeviceService";
import DeviceTree from "@/views/components/wvp/common/DeviceTree";
import channelMapInfobox from "@/views/components/wvp/dialog/channelMapInfobox";
import devicePlayer from '@/views/components/wvp/dialog/devicePlayer.vue'
import queryTrace from '@/views/components/wvp/dialog/queryTrace.vue'
...
.infobox-content::after {
  ...
  width: 16px;
  height: 16px;
  background: url('/public/static/wvp/images/arrow.png') no-repeat center;
}
.infobox-close {
  position: absolute;
  right: 1rem;
