...
import deviceEdit from '@/views/components/wvp/dialog/deviceEdit.vue'
import syncChannelProgress from '@/views/components/wvp/dialog/SyncChannelProgress.vue'
...
export default {
  ...
  methods: {
    ...
    showChannelList: function (row) {
      this.$router.push(`/wvp/channelList/${row.deviceId}/0`);
    },
    showDevicePosition: function (row) {
      this.$router.push(`/wvp/map?deviceId=${row.deviceId}`);
    },
