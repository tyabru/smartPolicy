  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="关注原因" prop="focusReason">
        <el-input
          v-model="queryParams.focusReason"
          placeholder="请输入关注原因-字典"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['person:fcous:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['person:fcous:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="fcousList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="小区名称" align="center" prop="xqId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        <el-form-item label="小区名称" prop="xqId">
          <el-input v-model="form.xqId" placeholder="请输入小区名称" />
        </el-form-item>
        <el-form-item label="关注原因" prop="focusReason">
          <el-input v-model="form.focusReason" placeholder="请输入关注原因-字典" />
        </el-form-item>
        <el-form-item label="重点关注级别" prop="level">
          <el-input v-model="form.level" placeholder="请输入重点关注级别" />
        </el-form-item>
        <el-form-item label="关注原因" prop="reasonDesc">
        ...
        <el-form-item label="人脸图片地址" prop="faceImgUrl">
          <el-input v-model="form.faceImgUrl" placeholder="请输入人脸图片地址" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除重点关注人口编号为"' + ids + '"的数据项？').then(function() {
        return delFcous(ids);
      }).then(() => {
        this.getList();
