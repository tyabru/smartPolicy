...
/**
 * 整改通知书下发审核对象 check_rectify_notice_distribute_review
 * 
 * @author jingyu
 * @date 2023-07-22
 */
public class CheckRectifyNoticeDistributeReview extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("rectifyNotice", getRectifyNotice())
